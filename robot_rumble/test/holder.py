...
class MyGame(arcade.Window):
    ...
    def on_draw(self):
        ...
        #use nearest filter for drawing all sprites in list, can change it so textures get uploaded as nearest filter instead if needed
        self.player_list.draw(filter=gl.NEAREST)
