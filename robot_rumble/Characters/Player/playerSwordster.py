...
class PlayerSwordster(PlayerBase):
    def __init__(self):
        ...
        self.attack_r, self.attack_l = load_spritesheet_pair("robot_rumble.assets.swordster_assets", "attack_unmasked.png", 22, 64, 32)
        self.running_r, self.running_l = load_spritesheet_pair("robot_rumble.assets.swordster_assets", "run_unmasked.png", 8, 32, 32)
        self.running_attack_r, self.running_attack_l = load_spritesheet_pair("robot_rumble.assets.swordster_assets", "attack_unmasked.png", 22, 64, 32)
        ...
        self.jumping_r, self.jumping_l = load_spritesheet_pair("robot_rumble.assets.swordster_assets", "jump_unmasked.png",
                                                               7, 32, 48)
        self.jumping_attack_r, self.jumping_attack_l = load_spritesheet_pair("robot_rumble.assets.swordster_assets",
