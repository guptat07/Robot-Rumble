    ...
    def __init__(self):
        ...
        for i in range(2):
            ...
            texture_idle_attack_r = arcade.load_texture(
                "sprites/robot1/robo1masked/robo1runattack-Sheet[32height32wide].png", x=32, y=0, width=32, height=32,
        ...
        for i in range(8):
            texture_running_attack_r = arcade.load_texture(
                "sprites/robot1/robo1masked/robo1runattack-Sheet[32height32wide].png", x=i * 32, y=0, width=32, height=32,
                hit_box_algorithm="Simple"
            )
        ...
        for i in range(7):
            ...
            for i in range(7):
                ...
                texture_jumping_attack_r = arcade.load_texture(
                    "sprites/robot1/robo1masked/robo1jumpattack-Sheet[48height32wide].png", x=i * 32, y=16, width=32,
                    height=32,
                    hit_box_algorithm="Simple"
                )
